...
const API_KEY= "AIzaSyDl-oudDuCfDq3Wl_uiSiLXthvM2moIKw8";
...
// Outgoing message by user handling
const handleOutgoingMessage = (e)=> {
    ...
    // create and displaying user messafe
...
//    respond with think
    setTimeout(() => {
        ...
        const incommingMessageDiv = createMessageElement(messageContent , "bot-message","thinking");
...
// handle and preview the selected file
...
// file upload cancel garne
fileCancelButton.addEventListener("click", () =>{
    userData.file = {};
    fileUploadWrapper.classList.remove("file-uploaded");
});

// Emoji peaker lai initialize gareko rw handke pani
